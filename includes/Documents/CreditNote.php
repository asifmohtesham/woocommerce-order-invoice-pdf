...
class CreditNote extends OrderDocumentMethods implements NumberedDocumentInterface, EmailAttachableInterface {
	...
	public function get_title(): string {
		...
		$title = __( 'Credit Note', 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function get_number_title(): string {
		...
		$title = __( 'Credit Note Number:', 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function get_date_title(): string {
		// override to allow for language switching!
		$title = __( 'Credit Note Date:', 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function get_filename( $context = 'download', $args = array() ): string {
		...
		$name        = _n( 'credit-note', 'credit-notes', $order_count, 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function init_settings(): void {
		...
		$settings_fields = array(
			...
			array(
				'type'     => 'setting',
				'id'       => 'display_date',
				'title'    => __( 'Display credit note date', 'woocommerce-pdf-invoices-packing-slips' ),
				'callback' => 'select',
				'section'  => 'credit_note',
				'args'     => array(
					'option_name' => $option_name,
					...
					'options'     => array(
						''           => __( 'No' , 'woocommerce-pdf-invoices-packing-slips' ),
						'1'          => __( 'Credit Note Date' , 'woocommerce-pdf-invoices-packing-slips' ),
						'order_date' => __( 'Refund Date' , 'woocommerce-pdf-invoices-packing-slips' ),
					),
				)
			),
			array(
				'type'     => 'setting',
				'id'       => 'display_number',
				'title'    => __( 'Display credit note number', 'woocommerce-pdf-invoices-packing-slips' ),
				'callback' => 'checkbox',
				'section'  => 'credit_note',
				'args'     => array(
					'option_name' => $option_name,
			...
			array(
				...
				'args'     => array(
					...
					'options'     => array(
						...
						'credit_note_number' => __( 'Separate credit note numbering' , 'woocommerce-pdf-invoices-packing-slips' ),
					),
			...
			array(
				...
				'title'    => __( 'Show original invoice number', 'woocommerce-pdf-invoices-packing-slips' ),
				'callback' => 'checkbox',
				'section'  => 'credit_note',
				'args'     => array(
					'option_name' => $option_name,
			...
			array(
				...
				'title'    => __( 'Next credit note number (without prefix/suffix etc.)', 'woocommerce-pdf-invoices-packing-slips' ),
					...
					'fields'      => array(
						'prefix'  => array(
							...
							'description' => __( 'If set, this value will be used as number prefix.' , 'woocommerce-pdf-invoices-packing-slips' ) . ' ' . sprintf(
								...
								strtolower( __( 'Credit Note', 'woocommerce-pdf-invoices-packing-slips' ) ), '<strong>[credit_note_year]</strong>', '<strong>[credit_note_month]</strong>'
			...
			array(
				...
				'title'    => __( 'Enable credit note number search in the orders list', 'woocommerce-pdf-invoices-packing-slips' ),
				'callback' => 'checkbox',
				'section'  => 'credit_note',
				'args'     => array(
					'option_name' => $option_name,
			...
			array(
				'type'     => 'setting',
				'id'       => 'positive_prices',
				'title'    => __( 'Use positive prices', 'woocommerce-pdf-invoices-packing-slips' ),
				'callback' => 'checkbox',
				'section'  => 'credit_note',
				'args'     => array(
					'option_name' => $option_name,
					'id'          => 'positive_prices',
					'description' => __( 'Prices in Credit Notes are negative by default, but some countries (like Germany) require positive prices.', 'woocommerce-pdf-invoices-packing-slips' ),
				)
			),
			array(
				'type'     => 'setting',
				'id'       => 'use_parent_data',
				'title'    => __( 'Use products & totals fallback', 'woocommerce-pdf-invoices-packing-slips' ),
				'callback' => 'checkbox',
				'section'  => 'credit_note',
				'args'     => array(
					'option_name' => $option_name,
					'id'          => 'use_parent_data',
					'description' => __( 'If orders are refunded without setting products, credit notes will not contain these details. This option provides a fallback method by using data from the original order for the credit note. This may cause issues in some setups, so testing is recommended.', 'woocommerce-pdf-invoices-packing-slips' ),
				)
			),
			array(
				'type'     => 'setting',
