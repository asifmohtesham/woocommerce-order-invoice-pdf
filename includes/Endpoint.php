...
if ( ! class_exists( '\\WOI\\PDF\\Endpoint' ) ) :
...
class Endpoint {
	...
	public function get_document_link( $order, $document_type, $additional_vars = array(), bool $bypass_login_access = false ) {
		...
		$additional_vars = apply_filters( 'woi_pdf_document_link_additional_vars', $additional_vars, $order, $document_type );
	...
	public function get_document_link_access_type() {
		...
		return apply_filters(
			'woi_pdf_document_link_access_type',
			$access_type,
			$this
		);
	}
	...
	public function get_document_denied_frontend_redirect_url() {
		...
		return apply_filters(
			'woi_pdf_document_denied_frontend_redirect_url',
