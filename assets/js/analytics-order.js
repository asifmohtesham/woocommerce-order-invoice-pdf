(() => {
	...
	(0, wp.hooks.addFilter)("woocommerce_admin_report_table", "woi-wc-admin-invoice-column", function (e) {
		return "orders" !== e.endpoint
			? e
			: ((e.headers = [].concat(r(e.headers), [{ label: woi_pdf_analytics_order.label, key: "order_invoice_number", screenReaderLabel: woi_pdf_analytics_order.label, isSortable: !1 }])),
