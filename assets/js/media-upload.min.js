// Based on original WP Overnight media-upload.js — adapted for woi-pdf-settings container
...
jQuery( document ).ready( function ( $ ) {
	...
	var get_media_field = function ( self, settings_wrapper, element_id ) {
		var $input = $( '#wpo-wcpdf-settings, #woi-pdf-settings' ).find( element_id ).filter( function () {
	...
	$( '#wpo-wcpdf-settings, #woi-pdf-settings, .wpo-wcpdf-setup' ).on( 'click', '.wpo_upload_image_button', function ( event ) {
	...
	$( '#wpo-wcpdf-settings, #woi-pdf-settings, .wpo-wcpdf-setup' ).on( 'click', '.wpo_remove_image_button', function ( event ) {
		var $sw     = $( this ).parent();
