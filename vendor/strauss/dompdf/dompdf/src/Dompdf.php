...
use DOMDocument;
use DOMNode;
use WOI\PDF\Vendor\Dompdf\Adapter\CPDF;
use DOMXPath;
use WOI\PDF\Vendor\Dompdf\Frame\Factory;
use WOI\PDF\Vendor\Dompdf\Frame\FrameTree;
use WOI\PDF\Vendor\Dompdf\Image\Cache;
use WOI\PDF\Vendor\Dompdf\Css\Stylesheet;
use WOI\PDF\Vendor\Dompdf\Helpers;
use WOI\PDF\Vendor\Masterminds\HTML5;
...
class Dompdf
{
    ...
    */
    ...
    /**
     * Return the underlying Canvas instance (e.g. WOI\PDF\Vendor\Dompdf\Adapter\CPDF, WOI\PDF\Vendor\Dompdf\Adapter\GD)
     *
     * @return Canvas
     */
