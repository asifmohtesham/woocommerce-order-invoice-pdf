 ...
 */
namespace WOI\PDF\Vendor\Dompdf\Frame;
...
use WOI\PDF\Vendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use WOI\PDF\Vendor\Dompdf\FrameReflower\Page as PageFrameReflower;
use WOI\PDF\Vendor\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator  = "WOI\\PDF\\Vendor\\Dompdf\\FrameDecorator\\$decorator";
        $reflower   = "WOI\\PDF\\Vendor\\Dompdf\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\WOI\\PDF\\Vendor\\Dompdf\\Positioner\\'.$type;
