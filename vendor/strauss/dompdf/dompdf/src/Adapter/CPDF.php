...
namespace WOI\PDF\Vendor\Dompdf\Adapter;

use WOI\PDF\Vendor\Dompdf\Canvas;
use WOI\PDF\Vendor\Dompdf\Dompdf;
use WOI\PDF\Vendor\Dompdf\Exception;
use WOI\PDF\Vendor\Dompdf\FontMetrics;
use WOI\PDF\Vendor\Dompdf\Helpers;
use WOI\PDF\Vendor\Dompdf\Image\Cache;
use WOI\PDF\Vendor\FontLib\Exception\FontNotFoundException;
...
class CPDF implements Canvas
{
     ...
     *
     * @var \WOI\PDF\Vendor\Dompdf\Cpdf
     */
    protected $_pdf;
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \WOI\PDF\Vendor\Dompdf\Cpdf(
            $size,
            true,
     ...
     *
     * @return \WOI\PDF\Vendor\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \WOI\PDF\Vendor\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
