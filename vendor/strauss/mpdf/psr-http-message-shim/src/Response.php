...
namespace WOI\PDF\Vendor\Mpdf\PsrHttpMessageShim;

use WOI\PDF\Vendor\Psr\Http\Message\StreamInterface;
use WOI\PDF\Vendor\Psr\Http\Message\ResponseInterface;
use WOI\PDF\Vendor\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \WOI\PDF\Vendor\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \WOI\PDF\Vendor\Psr\Http\Message\StreamInterface */
	private $stream;
