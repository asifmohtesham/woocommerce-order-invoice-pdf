...
namespace WOI\PDF\Vendor\Mpdf\Css;

use WOI\PDF\Vendor\Mpdf\Color\ColorConverter;
use WOI\PDF\Vendor\Mpdf\CssManager;
use WOI\PDF\Vendor\Mpdf\Exception\InvalidArgumentException;
...
class CssMerger
{
	...
	/**
	 * @var \WOI\PDF\Vendor\Mpdf\Css\NormalizeProperties
	 */
	private $normalizeProperties;

	/**
	 * @var \WOI\PDF\Vendor\Mpdf\Css\InlineStyleParser
	 */
	private $inlineStyleParser;

	/**
	 * @var \WOI\PDF\Vendor\Mpdf\Css\SelectorParser
	 */
	private $selectorParser;

	/**
	 * @var \WOI\PDF\Vendor\Mpdf\Css\InlinePropertyConverter
	 */
	...
	/**
	 * @var \WOI\PDF\Vendor\Mpdf\Css\BorderMerger
	 */
