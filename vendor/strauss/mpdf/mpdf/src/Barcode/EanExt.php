 ...
 */
class EanExt extends \WOI\PDF\Vendor\Mpdf\Barcode\AbstractBarcode implements \WOI\PDF\Vendor\Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $length = 5)
	{
		...
		if ($length == 2) {
			...
			throw new \WOI\PDF\Vendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid EAN barcode value "%s"', $code));
		}
