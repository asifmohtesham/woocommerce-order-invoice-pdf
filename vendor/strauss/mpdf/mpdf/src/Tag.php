...
class Tag
{
	...
	/**
	 * @param \WOI\PDF\Vendor\Mpdf\Mpdf $mpdf
	 * @param \WOI\PDF\Vendor\Mpdf\Cache $cache
	 * @param \WOI\PDF\Vendor\Mpdf\CssManager $cssManager
	 * @param \WOI\PDF\Vendor\Mpdf\Form $form
	 * @param \WOI\PDF\Vendor\Mpdf\Otl $otl
	 * @param \WOI\PDF\Vendor\Mpdf\TableOfContents $tableOfContents
	 * @param \WOI\PDF\Vendor\Mpdf\SizeConverter $sizeConverter
	 * @param \WOI\PDF\Vendor\Mpdf\Color\ColorConverter $colorConverter
	 * @param \WOI\PDF\Vendor\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \WOI\PDF\Vendor\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \WOI\PDF\Vendor\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'WOI\PDF\Vendor\Mpdf\Tag\\';
