...
class Style
{
    ...
    public function fromStyleSheets(AbstractTag $tag, $attributes) {
        ...
        foreach ($stylesheets as $_sc) {
            ...
            /** @var \WOI\PDF\Vendor\Sabberworm\CSS\RuleSet\DeclarationBlock $_decl */
            foreach ($_sc->getAllDeclarationBlocks() as $_decl) {

                /** @var \WOI\PDF\Vendor\Sabberworm\CSS\Property\Selector $_selector */
                foreach ($_decl->getSelectors() as $_selector) {
                    ...
                    if ($class !== null) {
                        foreach ($class as $_class) {
                            if ($_selector === ".$_class") {
                                /** @var \WOI\PDF\Vendor\Sabberworm\CSS\Rule\Rule $_rule */
