...
use WOI\PDF\Vendor\FontLib\AdobeFontMetrics;
use WOI\PDF\Vendor\FontLib\Font;
use WOI\PDF\Vendor\FontLib\BinaryStream;
use WOI\PDF\Vendor\FontLib\Table\Table;
use WOI\PDF\Vendor\FontLib\Table\DirectoryEntry;
use WOI\PDF\Vendor\FontLib\Table\Type\glyf;
use WOI\PDF\Vendor\FontLib\Table\Type\name;
use WOI\PDF\Vendor\FontLib\Table\Type\nameRecord;
...
class File extends BinaryStream {
  ...
  protected function readTable($tag) {
    ...
    if (!self::$raw) {
      ...
      $class = "WOI\\PDF\\Vendor\\FontLib\\Table\\Type\\$name_canon";
      ...
      $class = "WOI\\PDF\\Vendor\\FontLib\\Table\\Table";
    }
