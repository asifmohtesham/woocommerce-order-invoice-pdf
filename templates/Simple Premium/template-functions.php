...
add_filter( 'woi_pdf_template_editor_defaults', 'woi_pdf_simple_template_defaults', 9, 3 );
add_filter( 'woi_pdf_template_editor_settings', 'woi_pdf_simple_template_defaults', 9, 3 );
function woi_pdf_simple_template_defaults ( $settings, $document_type, $settings_name ) {
...
add_filter( 'woi_pdf_ink_saving_supported_templates', function( $templates ) {
	$templates[] = 'premium_plugin/Simple Premium';
	return $templates;
} );

add_filter( 'woi_pdf_ink_saving_css', function( $css, $document, $current_template ) {
